...
// Inline marks keep generated signatures self-contained instead of loading
// tracking-capable image assets from getmailspring.com.
const FB_SHARE = socialMark('f');
const MEDIUM_SHARE = socialMark('M');
const GITHUB_SHARE = socialMark('G');
const YOUTUBE_SHARE = socialMark('Y');
const TWITTER_SHARE = socialMark('X');
const LINKEDIN_SHARE = socialMark('in');
const INSTAGRAM_SHARE = socialMark('I');
