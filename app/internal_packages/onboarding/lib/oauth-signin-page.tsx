...
export const OAUTH_COMPLETION_HTML = `<!doctype html><html lang="zh-CN"><meta charset="utf-8"><title>凯越邮箱</title><body style="font-family:system-ui,sans-serif;padding:40px"><h1>登录完成</h1><p>你可以关闭此页面并返回凯越邮箱。</p></body></html>`;
  ...
  componentDidMount() {
    ...
    this._server = http.createServer((request, response) => {
      ...
      if (code) {
        ...
        response.end(OAUTH_COMPLETION_HTML);
      } else {
