...
var KaiyueConfig = require('../kaiyue-config.json');
...
module.exports = ErrorLogger = (function () {
  function ErrorLogger(args) {
    ...
    if (KaiyueConfig.privacy.enableOfficialCrashReporting && KaiyueConfig.privacy.crashReportUrl) {
    ...
    this.extensions = KaiyueConfig.privacy.enableOfficialTelemetry
      ? [
  ...
  ErrorLogger.prototype._startCrashReporter = function (args) {
    ...
    require('electron').crashReporter.start({
      ...
      submitURL: KaiyueConfig.privacy.crashReportUrl,
      uploadToServer: true,
      autoSubmit: true,
      extra: {
        ver: appVersion,
