      ...
      app.setJumpList([
        {
          ...
          items: [
            ...
            },
            {
              ...
              program: process.execPath,
              args: `${KaiyueConfig.brand.protocol}://open-inbox`,
              iconPath: process.execPath,
              iconIndex: 0,
            },
            {
            ...
            },
            {
              ...
              description: localized(`Open ${KaiyueConfig.brand.name} preferences`),
              program: process.execPath,
              args: `${KaiyueConfig.brand.protocol}://open-preferences`,
              iconPath: process.execPath,
              iconIndex: 0,
            },
          ],
