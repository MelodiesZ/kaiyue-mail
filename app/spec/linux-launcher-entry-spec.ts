...
describe('marshalMessage', () => {
  ...
  it('is byte-identical to the reference dbus-next output', () => {
    ...
    // Update('application://KaiyueMail.desktop', {count: Int64(5), count-visible: true})
    // with serial 1. Guards the hand-rolled marshaller against regressions.
    const expected =
      '6c04000164000000010000008400000001016f002e0000002f636f6d2f63616e6f6e6963616c2f' +
      '756e6974792f6c61756e63686572656e7472792f6b61697975652d6d61696c00000201730021000000' +
      ...
      '696f6e3a2f2f4b61697975654d61696c2e6465736b746f7000000000340000000000000005000000636f' +
